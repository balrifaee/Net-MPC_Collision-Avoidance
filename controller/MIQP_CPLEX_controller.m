...
function [U,trajectoryPrediction,controllerOutput] = MIQP_CPLEX_controller( scenario,iter, ~ )
    ...
    if iter.reset
        ...
        CPLEXoptions.mip.tolerances.integrality = 1e-9;
    ...
    fprintf('cplexmiqp status: flag %i | %s | %s | fval %8f | min_avoid_constr %8e\n', exitflag, output.cplexstatusstring, output.message,fval+mip.r_MIQP, min_avoid_constr);
